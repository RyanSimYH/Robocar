...
//uses https://gist.github.com/bmccormack/d12f4bf0c96423d03f82
/**
...
int main() {
    ...
    float sample[15];// collect sample
    int arrNumbers[10]={0};//number of sample used for average
    int pos =0;
    float newAvg = 0;
    float sum = 0;
    ...
    while (true) {
        ...
        float  distance = measure_distance();
            ...
            printf("The new average is %5.2f\n", newAvg);
            pos++;
            if (pos >= len){
            pos = 0;
            }
